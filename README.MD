...
* [LiteFrame](https://github.com/AVONnadozie/LiteFrame) - A lightweight PHP framework for small and medium scale applications. Uses RedBeanPHP to automatically build your database on the fly. (No migration files required)   **By [@AVONnadozie](https://twitter.com/AVONnadozie)**
...
* [NettyFinder](https://github.com/BolajiAyodeji/netty-finder) - This script checks a Nigerian Telephone number and detects which  network it belongs to. **By [@iambolajiayo](https://twitter.com/iambolajiayo)**
